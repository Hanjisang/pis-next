...
13. 管理细胞病理制备、筛查、复核和诊断责任；
14. 管理分子检测任务、运行、质控、结果验证和医学判读；
15. 管理外送检测、外部结果核验、外院材料和剩余材料关闭。
...
### EXT-SYS-013：外部检测实验室或送检机构

外部检测机构可能接收 PIS 外送的原始标本、完整蜡块、完整玻片或派生材料，并返回检测结果和报告。

PIS 负责：

- 建立外送检测记录和外部标识映射；
- 记录发送材料、交接责任、时间、数量和状态；
- 核验患者、标本、来源、方法、完整性、机构资质和报告有效性；
- 保留外部原始报告、剩余材料状态和本地医学确认责任。

外部机构的检测运行、设备原始结果和实验室内部质量流程不被伪装成本地事实。外部机构未返回剩余材料状态时，PIS 不得自动认定材料已销毁或退回。

### EXT-SYS-014：关联检测或 HPV 检测来源

关联检测可以由 PIS 本地实验室、医院其他实验室或外部机构完成。PIS 负责保留独立检测任务、结果身份、判读责任和与细胞学病例的稳定关系；同一综合报告展示不改变业务对象独立性。
